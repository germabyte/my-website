...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        "my_projects.txt": "1. ConcordatoFacile is a cloud-based platform designed to streamline lease contract management for property owners unions. Utilizing Google Workspace and JotForm, it simplifies the creation and administration of contracts, ensuring accuracy while minimizing manual input. The platform is committed to data privacy and security, adhering to GDPR and HIPAA standards, and operates without storing user data. This project is a blend of real estate expertise and IT innovation, aiming to modernize lease contract management. For further details, visit 'concordatofacile.xyz'.\n2. Insert project description here...",
