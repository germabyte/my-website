...
var configs = (function () {
 ...
 Singleton.defaultOptions = {
    ...
    welcome: "Hello! I'm Germano Riccio, a No-Code Specialist.\nI assist traditional businesses in Italy with their digital transitions, streamlining complex processes by crafting tailored IT solutions. Alongside, I have an interest in OSINT and enjoy sci-fi.\nTo view a list of available terminal commands, type 'help'.\nFor an overview of the services I offer, type 'open services.txt'.\nInterested in my past projects? Access my GitHub by typing 'open github.url' or click on the GitHub link in the menu on the left.\nTo explore my certifications and professional background, type 'open linkedin.url' or use the LinkedIn link which is accessible via the menu.\nThank you for visiting, and happy exploring!",
